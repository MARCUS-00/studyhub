  ...
  return (
    <div className="w-full max-w-xs rounded-xl bg-white px-12 py-8 border-2 border-gray-400 shadow-2xl text-center lg:px-18 lg:py-10">
      <Image
        ...
        width={80}
        height={80}
        className="inline-block h-20 w-20 rounded-full border-2 object-cover"
      />
      ...
      <div className="mt-6">
        ...
        <span className="mt-2 text-lg font-bold text-black">Aka</span>
      </div>
      ...
      <div className="mt-4">
        ...
        <p className="text-sm text-black">
          I am a passionate UX designer with a focus on creating intuitive and
          user-friendly interfaces. I enjoy solving complex problems and
          translating user needs into elegant design solutions.
        </p>
      </div>
    </div>
  );
