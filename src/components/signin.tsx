  ...
  const onSubmit = async () => {
    ...
    if (result?.ok) {
      ...
      globalThis.location.href =
        role === "STAFF" ? "/staffDashboard" : "/dashboard";
    }
  };
    ...
    <div className="w-full max-w-md fade-up">
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            placeholder="you@college.edu or REG2024001"
            className={inputCls}
          />
        </div>
        <div>
          ...
          <div className="relative">
            ...
            >
              {showPw ? (
                <AiOutlineEyeInvisible size="1.1rem" />
              ) : (
      ...
      <div className="flex flex-col items-center gap-2 mt-6">
        <p className="text-sm text-muted">
          ...
          <Link
            href="/signup"
            className="font-semibold text-forest hover:text-emerald transition-colors"
          >
            Create one
          </Link>
        </p>
